...
def bound_1(bound_pattern, bound_2, bound_3, bound_4, bound_list, screen):

    if bound_pattern % 64 == 1:
        screen.blit(bound_list[7][0], (bound_list[7][1], 50))
    ...
    if bound_pattern % 64 == 5:
        screen.blit(bound_list[6][0], (bound_list[6][1], 50))
    ...
    if bound_pattern % 64 == 9:
        screen.blit(bound_list[5][0], (bound_list[5][1], 50))
    ...
    if bound_pattern % 64 == 13:
        screen.blit(bound_list[4][0], (bound_list[4][1], 50))
    ...
    if bound_pattern % 64 == 17:
        screen.blit(bound_list[3][0], (bound_list[3][1], 50))
    ...
    if bound_pattern % 64 == 21:
        screen.blit(bound_list[2][0], (bound_list[2][1], 50))
    ...
    if bound_pattern % 64 == 25:
        screen.blit(bound_list[1][0], (bound_list[1][1], 50))
    ...
    if bound_pattern % 64 == 29:
        screen.blit(bound_list[0][0], (bound_list[0][1], 50))
